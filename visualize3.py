...
from path_search3.vec2 import Vec2, euclidean_distance
from path_search3.a_star import AStar
from path_search3.points import random_euclidean_points, connect_points
from path_search3.graph import Graph
...
class GlobalState:
    ...
    def on_draw(self):
        self.draw_nodes([node for node in self.graph.nodes])
    ...
    def draw_nodes(self, nodes, color = (128, 128, 128, 128)):
        points = [data for data in nodes]
        vertices = []
        index = []
        start_index = 0
        for point in points:
    ...
    def draw_path(self, path):
        ...
        self.draw_nodes(path.nodes, color = orange)
